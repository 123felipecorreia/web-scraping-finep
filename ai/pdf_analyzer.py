...
class PDFAnalyzer:
    ...
    def _create_analysis_prompt(self, chunk: str) -> str:
        ...
        Seu objetivo é identificar e extrair informações completas e contextualizadas sobre oportunidades de fomento à pesquisa disponíveis em sites oficiais de agências, fundações e programas de financiamento público ou privado.
